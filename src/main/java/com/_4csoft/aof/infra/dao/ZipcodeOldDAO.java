 ...
 * @Project : aof5-infra
 * @Package : com._4csoft.aof.infra.dao
 * @File : ZipcodeOldDAO.java
 * @Title : ZipcodeOld DAO
 * @date : 2013. 4. 18.
 * @author : 김종규
 * @descrption : 우편번호 관리 
 */
@Repository ("UIZipcodeOldDAO")
public class ZipcodeOldDAO extends BaseDAO {
	...
	public List<ResultSet> getList(SearchConditionVO conditionVO) throws Exception {
		return (List<ResultSet>)list("UIZipcodeOldDAO.getList", conditionVO);
	}
	...
	public int countList(SearchConditionVO conditionVO) throws Exception {
		return (Integer)getSqlMapClientTemplate().queryForObject("UIZipcodeOldDAO.countList", conditionVO);
	}
